                ...
                <div className="flex-shrink-0 p-4 lg:p-6 bg-[#0d1017] border-t border-white/5 space-y-4 relative z-20">
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-xl p-3 lg:p-4 hover:border-white/20 transition-all">
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex-1 min-w-0">
                        <label className="text-xs font-bold text-blue-400 mb-1.5 block">البرومبت:</label>
                  ...
                  <div className="flex items-center gap-3">
                    <Button
                      ...
                      className="flex-1 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 h-10 lg:h-11 text-sm font-bold shadow-lg shadow-blue-500/20"
                    >
