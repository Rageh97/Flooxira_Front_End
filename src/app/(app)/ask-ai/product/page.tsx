...
export default function ProductModelPage() {
  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden text-white font-sans" dir="rtl">
      {/* Background Effects */}
     ...
     {/* Header */}
      ...
      {/* Main Layout */}
      <div className="flex-1 flex overflow-hidden max-w-[2000px] mx-auto w-full relative rounded-xl border border-white/10 bg-[#0a0c10]/50">
        {/* Overlay */}
        {showSettings && (
          <div 
