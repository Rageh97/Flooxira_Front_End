        ...
        <CardHeader className="border-text-primary/50">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600">Manage Telegram chats and assign agents</p>
            </div>
            ...
            {adminChats.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="text-sm text-gray-400 mt-2">
                  Connect Telegram and send/receive some messages to see chat data here.
                </p>
              </div>
            ) : (
              <div className="space-y-4">
                    ...
                    <div key={chat.id} className="border rounded-lg p-3 bg-gray-50">
                      <div className="flex items-center justify-between">
                        <div className="flex-1">
                          <p className="font-medium text-sm">{chat.chatId}</p>
