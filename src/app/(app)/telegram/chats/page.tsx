        ...
        <div className="p-3 border-t">
          ...
          <div className="flex items-end gap-2">
            ...
            <button
              ...
              className="flex items-center justify-center rounded-lg transition-colors mb-3 flex-shrink-0"
            >
              <img src="/imogi.gif" alt="" className="w-8 h-8 sm:w-10 sm:h-10" />
            </button>
            ...
            <div className="flex-1 relative">
              <Textarea
                ...
                rows={1}
                className="w-full px-14 bg-fixed-40 text-[16px] sm:text-base border-primary rounded-2xl text-white placeholder-white/50 resize-none overflow-hidden outline-none py-3"
                style={{ minHeight: '40px', maxHeight: '150px' }}
              />

              {/* Media upload button - Right */}
              <label className="absolute right-2 top-1/2 -translate-y-1/2 cursor-pointer z-10">
                <div className="h-9 w-9 mb-1 rounded-full bg-gray-600 flex items-center justify-center transition-all hover:bg-gray-500">
              ...
              >
                {sending ? (
                  <div className="h-9 w-9 mb-1 rounded-full bg-gray-600 flex items-center justify-center">
