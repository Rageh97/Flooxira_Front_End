...
export async function generateAIVideo(token: string, payload: { prompt: string; aspectRatio?: string; duration?: number; includeAudio?: boolean; model?: string }) {
...
export async function processAIVideo(token: string, payload: { operation: string; inputUrl: string; prompt?: string; aspectRatio?: string; duration?: number; model?: string }) {
